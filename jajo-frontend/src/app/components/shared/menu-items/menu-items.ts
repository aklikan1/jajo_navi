...
const MENUITEMS = [
  ...
  { state: 'transport', type: 'link', name: 'Transport', icon: ' local_shipping'},
  { state: 'address', type: 'link', name: 'Addresses', icon: 'satellite'},
  { state: 'products', type: 'link', name: 'Products', icon: 'local_offer'},
